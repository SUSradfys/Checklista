    ...
    public partial class SelectPlanWindow : Form
    {
        ...
        private void listBoxPlans_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {                
                ...
                {
                    Checklist checklist = new Checklist((Patient)textBoxPatient.Tag, (Course)listBoxCourses.SelectedItem, (PlanSetup)listBoxPlans.SelectedItem, selectChecklistWindow.ChecklistType, "r150801", "Fysiker");
                    checklist.Analyze();
                }
            }
        }
